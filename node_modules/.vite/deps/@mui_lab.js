...
import "./chunk-WSVNIRSH.js";
import "./chunk-RZXG6YXI.js";
import {
  LoadingButton_default,
  getLoadingButtonUtilityClass,
  loadingButtonClasses_default
} from "./chunk-IJDN6Q3V.js";
import "./chunk-WOPFJJW7.js";
import "./chunk-OXXLDK5Y.js";
import "./chunk-MS5V32R7.js";
import "./chunk-RWZJRNUH.js";
import {
  Timeline_default,
  getTimelineUtilityClass,
  timelineClasses_default
} from "./chunk-DCQ5BIXU.js";
import {
  TimelineConnector_default,
  getTimelineConnectorUtilityClass,
  timelineConnectorClasses_default
} from "./chunk-WTKXO5EB.js";
import {
  TimelineContent_default,
  getTimelineContentUtilityClass,
  timelineContentClasses_default
} from "./chunk-Y2S2WMXZ.js";
import "./chunk-BTVQPI5E.js";
import "./chunk-HC4K54PT.js";
import {
  TimelineDot_default,
  getTimelineDotUtilityClass,
  timelineDotClasses_default
} from "./chunk-OLJRYKXM.js";
import {
  useAutocomplete
} from "./chunk-KRVK7BFT.js";
import "./chunk-BLABIOU6.js";
import "./chunk-2VGNWSB2.js";
import {
  require_react_dom
} from "./chunk-ZRJG7NCB.js";
import "./chunk-FMFFUJ5P.js";
import "./chunk-KUOTRGLU.js";
import "./chunk-4Z7X42BB.js";
import "./chunk-PJHOYXPB.js";
import "./chunk-CY56KJHS.js";
import "./chunk-EKIAD55F.js";
import "./chunk-BEM72OCM.js";
import "./chunk-GUL3KLHI.js";
import "./chunk-WTTVI6SU.js";
import {
...
var _excluded3 = ["children", "className", "component", "columns", "spacing", "sequential", "defaultColumns", "defaultHeight", "defaultSpacing"];
...
var Masonry = React42.forwardRef(function Masonry2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiMasonry"
  });
  ...
  const masonryRef = React42.useRef();
  const [maxColumnHeight, setMaxColumnHeight] = React42.useState();
  const isSSR = !maxColumnHeight && defaultHeight && defaultColumns !== void 0 && defaultSpacing !== void 0;
  const [numberOfLineBreaks, setNumberOfLineBreaks] = React42.useState(isSSR ? defaultColumns - 1 : 0);
  const ownerState = _extends({}, props, {
    spacing,
    columns,
    maxColumnHeight,
  ...
  const handleResize = React42.useCallback((masonryChildren) => {
  ...
  const lineBreaks = new Array(numberOfLineBreaks).fill("").map((_, index) => (0, import_jsx_runtime17.jsx)("span", {
    "data-class": "line-break",
    style: _extends({}, lineBreakStyle, {
      order: index + 1
    })
  }, index));
  return (0, import_jsx_runtime18.jsxs)(MasonryRoot, _extends({
    as: component,
    className: clsx_default(classes.root, className),
    ref: handleRef,
    ownerState
...
true ? Masonry.propTypes = {
   ...
   * @default 4
   */
  columns: import_prop_types4.default.oneOfType([import_prop_types4.default.arrayOf(import_prop_types4.default.oneOfType([import_prop_types4.default.number, import_prop_types4.default.string])), import_prop_types4.default.number, import_prop_types4.default.object, import_prop_types4.default.string]),
  /**
   ...
   */
  defaultColumns: import_prop_types4.default.number,
  /**
   * The default height of the component in px. This is provided for server-side rendering.
   */
  defaultHeight: import_prop_types4.default.number,
  /**
   * The default spacing of the component. Like `spacing`, it is a factor of the theme's spacing. This is provided for server-side rendering.
   */
  defaultSpacing: import_prop_types4.default.number,
  /**
   * Allows using sequential order rather than adding to shortest column
   * @default false
   */
  sequential: import_prop_types4.default.bool,
  /**
